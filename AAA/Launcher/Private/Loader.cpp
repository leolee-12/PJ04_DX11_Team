...
HRESULT CLoader::Ready_WorkQueue()
{
    ...
    case LEVEL::TOWN_STEP3:
        if (FAILED(Read_Manifest(LAUNCHER_LEVEL_PROFILES::LEVEL_TOWN_STEP3, LEVEL::TOWN_STEP3)))
            return E_FAIL;
        break;
    ...
    case LEVEL::ARENA:
        ...
        break;
    case LEVEL::ENDING:
        if (FAILED(Read_Manifest(LAUNCHER_LEVEL_PROFILES::LEVEL_ENDING, LEVEL::ENDING)))
            return E_FAIL;
        break;
    case LEVEL::END:
        break;
