...
namespace Engine
{
	...
	typedef struct tagVertexMesh
	{
		...
		static constexpr D3D11_INPUT_ELEMENT_DESC   Elements[] = {
			...
			{"BINORMAL", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0, 68, D3D11_INPUT_PER_VERTEX_DATA, 0},
		};
	}VTXMESH;
	...
	typedef struct tagVertexAnimationMesh
	{
		...
		static constexpr D3D11_INPUT_ELEMENT_DESC   Elements[] = {
			...
			{"TANGENT",     0, DXGI_FORMAT_R32G32B32_FLOAT,	   0, 56, D3D11_INPUT_PER_VERTEX_DATA, 0},
			{"BINORMAL",    0, DXGI_FORMAT_R32G32B32_FLOAT,	   0, 68, D3D11_INPUT_PER_VERTEX_DATA, 0},
			{"BLENDINDEX",  0, DXGI_FORMAT_R32G32B32A32_UINT,  0, 80, D3D11_INPUT_PER_VERTEX_DATA, 0},
			{"BLENDWEIGHT", 0, DXGI_FORMAT_R32G32B32A32_FLOAT, 0, 96, D3D11_INPUT_PER_VERTEX_DATA, 0},
		};
	}VTXANIMMESH;
