...
namespace Engine
{
	...
	enum class RENDERUIID {BACK, MIDDLE, FRONT, CURTAIN, END};
	...
	enum class POSTPROSESS { BRIGHT, BLUR, COMPSITE, SSAO, SSAO_BLUR, SSR, DOF_DOWN, DOF_BLUR, DOF_COMPOSITE, CURTAIN_COMPOSITE, END };
