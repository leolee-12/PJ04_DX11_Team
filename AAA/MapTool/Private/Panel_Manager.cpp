...
void CPanel_Manager::Render_DockSpace()
{
    ...
    if (!m_bLayoutBuilt && ImGui::DockBuilderGetNode(dockspace_id) == nullptr)
    {
        ...
        ImGui::DockBuilderSplitNode(dockspace_id, ImGuiDir_Up,   0.06f, &top,   &rest);
        ImGui::DockBuilderSplitNode(rest,         ImGuiDir_Left, 0.18f, &left,  &center);
        ...
        ImGui::DockBuilderSplitNode(left,         ImGuiDir_Down, 0.5f,  &leftBottom, &left);
