...
namespace
{
	constexpr const _tchar* CRASH_EFFECT_CONFIG_PATH = L"../../Resources/YSE/Effect/Crash/Crash/CrashEffect.JSON";
...
HRESULT CLevel_Edit::Initialize()
{
	...
	if (FAILED(Load_CrashEffectPreview()))
		MapTool::Log_Warning("CrashEffect preview load skipped: Resources/YSE/Effect/Crash/Crash/CrashEffect.JSON");
