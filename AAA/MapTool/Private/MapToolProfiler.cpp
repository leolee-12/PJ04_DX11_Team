...
void CMapToolProfiler::Capture_Frame()
{
	...
	if (nullptr != pProxy)
	{
		...
		Frame.iTextureHubCached = Stats.iCachedSRVCount;
		Frame.iTextureHubReused = Stats.iCacheReuseCount;
		Frame.iTextureHubLoaded = Stats.iFirstLoadRequestCount;
		Frame.iTextureHubFailed = Stats.iLoadFailCount;
