...
private:
	...
	static ENV_SOURCE_TYPE Classify_SourceType(const _wstring& strSourceFile);
	static ENV_EFFECT_TYPE Classify_EffectType(const _wstring& strObjectName, const _wstring&
		strComponentName);
