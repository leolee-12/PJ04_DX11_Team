...
namespace Client
{
	enum class LEVEL { STATIC, FIRST_LOADING, LOADING, STAGE0_STEP1, STAGE0_STEP2, TOWN_STEP1, TOWN_STEP2, TOWN_STEP3,
		BOSS_STAGE1, STAGE1_STEP1, STAGE1_STEP2, STAGE1_STEP3, ARENA, ENDING, TEST, END };
