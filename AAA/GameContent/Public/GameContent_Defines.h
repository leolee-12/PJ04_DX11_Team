...
namespace Client
{
	enum class LEVEL { STATIC, FIRST_LOADING, LOADING, STAGE0_STEP1, STAGE0_STEP2, TOWN_STEP1, BOSS_STAGE1, 
		STAGE1_STEP1, STAGE1_STEP2, STAGE1_STEP3, TEST, END };

	enum class VTXTEX_SHADER { DEFAULT, ALPHABLEND };

	enum class KIRBY_SHADER_PASS { KIRBY, ANIM_TEXTURED_PBR, ANIM_CONSTANT_PBR, ANIM_SHADOW, BOMBHAT, ICEHAT, HAT_DECOICE };
