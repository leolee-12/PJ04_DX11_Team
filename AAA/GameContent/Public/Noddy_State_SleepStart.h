...
class CNoddy_State_SleepStart final : public CMonster_State
{
protected:
    CNoddy_State_SleepStart() = default;
    virtual ~CNoddy_State_SleepStart() = default;
...
public:
    static CNoddy_State_SleepStart* Create(const ANI_PLAY_INFO& tInfo, _float fSpeed = 0.f);
