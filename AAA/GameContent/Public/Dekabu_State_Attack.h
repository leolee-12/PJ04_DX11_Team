...
class CDekabu_State_Attack final : public CMonster_State
{
protected:
    CDekabu_State_Attack() = default;
    virtual ~CDekabu_State_Attack() = default;
...
public:
    static CDekabu_State_Attack* Create(const ANI_PLAY_INFO& tInfo = {}, _float fSpeed = 0.f);
