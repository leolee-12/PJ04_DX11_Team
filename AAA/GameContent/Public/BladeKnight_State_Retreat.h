...
class CBladeKnight_State_Retreat final : public CMonster_StateT<CBladeKnight>
{
private:
	CBladeKnight_State_Retreat() = default;
	virtual ~CBladeKnight_State_Retreat() = default;
...
public:
	static CBladeKnight_State_Retreat*	Create();
