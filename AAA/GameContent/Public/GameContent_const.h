...
namespace ProtoDesc
{
	...
	// JumpEffect
	inline constexpr TEXTURE_DESC Texture_JumpEffect = { ETOUI(LEVEL::STATIC), TEXT("Prototype_Component_Texture_JumpEffect"), TEXT("../../Resources/YSE/Effect/JumpEffect/JumpTex.png"), 1 };
