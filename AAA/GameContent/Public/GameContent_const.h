...
namespace ProtoDesc
{
	...
	inline constexpr TEXTURE_DESC Texture_Meta_Line2 = { ETOUI(LEVEL::STATIC), TEXT("Prototype_Component_Texture_Meta_Line2"), TEXT("../../Resources/YSH/Boss/Metaknight/Effect/Lock/Line2.png"), 1 };
