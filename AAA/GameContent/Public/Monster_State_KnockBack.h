...
class CMonster_State_KnockBack final : public CMonster_StateT<CMonster>
{
private:
...
public:
	static CMonster_State_KnockBack* Create(const ANI_PLAY_INFO& tInfo, _float fSpped = 0.f);
