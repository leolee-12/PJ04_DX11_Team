...
class CBladeKnight_State_Landing final : public CMonster_StateT<CBladeKnight>
{
private:
	CBladeKnight_State_Landing() = default;
	virtual ~CBladeKnight_State_Landing() = default;
...
public:
	static CBladeKnight_State_Landing* Create();
