...
class CKabu_State_WarpIn final : public CMonster_State
{
protected:
    CKabu_State_WarpIn() = default;
    virtual ~CKabu_State_WarpIn() = default;
...
public:
    static CKabu_State_WarpIn*  Create(const ANI_PLAY_INFO& tInfo = {}, _float fSpeed = 0.f);
