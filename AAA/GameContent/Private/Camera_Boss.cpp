...
CCamera_Boss::CCamera_Boss(ID3D11Device* pDevice, ID3D11DeviceContext* pContext) : CCamera(pDevice, pContext) {}
CCamera_Boss::CCamera_Boss(const CCamera_Boss& Prototype) : CCamera(Prototype) {}
