...
void CKirby_StateMachine::Request_PositionSync_StateMachine(const KIRBY_POSITION_SYNC_BEGIN_DESC* pDesc)
{
    switch (pDesc->eType)
    {
        ...
        {
            Change_State(KIRBY_STATE_TYPE::METAKNIGHT_UPPERCALIBUR);
            break;
        }
...
HRESULT CKirby_StateMachine::Init_State()
{
    ...
    if (FAILED(Register_State(KIRBY_STATE_TYPE::METAKNIGHT_UPPERCALIBUR, CKirby_UpperCalibur::Create())))       return E_FAIL;
