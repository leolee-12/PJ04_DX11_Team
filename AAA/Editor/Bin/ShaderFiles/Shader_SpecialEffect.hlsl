...
float4 ApplyMaskBlend(float4 vColor, float4 vMaskValue)
{
    ...
    clip(vMaskValue.r - g_fAlphaClip);
    return vColor;
}
...
float4 ApplyColorToAlpha(float4 vTextureValue, bool bUseColorToAlpha)
{
    ...
    {
        clip(vTextureValue.r - g_fAlphaClip);
        vTextureValue = float4(1.f, 1.f, 1.f, 1.f);
    }
...
float4 ComposeEffectColor(float2 vTexcoord, SamplerState EffectSampler, bool bLensFlareRing)
{
    ...
    if (g_bUseTexture == true)
    {
        ...
        float2 vUV = g_vTextureOffset + vRotatedUV * g_vTextureTiling + vUVDistortion;
    ...
    if (g_bUseDiffuseTexture == true)
    {
        ...
        float2 vUV = g_vDiffuseOffset + vRotatedUV * g_vDiffuseTiling + vUVDistortion;
    ...
    if (g_bUseUnknownTexture == true)
    {
        ...
        float2 vUV = g_vUnknownOffset + vRotatedUV * g_vUnknownTiling + vUVDistortion;
...
{
    return ComposeEffectColor(vTexcoord, LinearSampler, false);
}

float4 ComposeEffectColor_Mirror(float2 vTexcoord)
{
    return ComposeEffectColor(vTexcoord, MirrorSampler, false);
}
...
PS_GBUFFER_OUT PS_GBUFFER(PS_IN In)
{
    ...
    if (g_bUseNormalTexture == true)
    {
        ...
        float2 vNormalRG = g_NormalTexture.Sample(LinearSampler, vNormalUV).rg;
...
PS_COLOR_OUT PS_LENSFLARE_RING_MIRROR(PS_IN In)
{
    PS_COLOR_OUT Out;
...
technique11 DefaultTechnique
{
    ...
    pass AlphaBlend_Mirror_DepthIgnore //13
    {
        SetRasterizerState(RS_Cull_None);
        SetDepthStencilState(DSS_Z_Disable, 0);
        SetBlendState(BS_AlphaBlend, float4(0.f, 0.f, 0.f, 0.f), 0xffffffff);
    ...
    pass Additive_Mirror_DepthIgnore //14
    {
        SetRasterizerState(RS_Cull_None);
        SetDepthStencilState(DSS_Z_Disable, 0);
        SetBlendState(BS_Additive, float4(0.f, 0.f, 0.f, 0.f), 0xffffffff);
    ...
    pass LensFlareRing_Mirror_DepthIgnore //15
    {
        SetRasterizerState(RS_Cull_None);
        SetDepthStencilState(DSS_Z_Disable, 0);
        SetBlendState(BS_Additive, float4(0.f, 0.f, 0.f, 0.f), 0xffffffff);
        ...
        SetVertexShader(CompileShader(vs_5_0, VS_MAIN()));
        SetGeometryShader(NULL);
        SetPixelShader(CompileShader(ps_5_0, PS_LENSFLARE_RING_MIRROR()));
    }


    pass DefaultPass_DepthIgnoreStencilMask //16
    {
        SetRasterizerState(RS_Cull_None);
    ...
    pass AlphaBlend_DepthIgnoreStencilMask //17
    {
        SetRasterizerState(RS_Cull_None);
        SetDepthStencilState(DSS_SpotlightDarken, 1);
        SetBlendState(BS_AlphaBlend, float4(0.f, 0.f, 0.f, 0.f), 0xffffffff);
    ...
    pass Additive_DepthIgnoreStencilMask //18
    {
        SetRasterizerState(RS_Cull_None);
        SetDepthStencilState(DSS_SpotlightDarken, 1);
        SetBlendState(BS_Additive, float4(0.f, 0.f, 0.f, 0.f), 0xffffffff);
    ...
    pass Max_DepthIgnoreStencilMask //19
    {
        SetRasterizerState(RS_Cull_None);
        SetDepthStencilState(DSS_SpotlightDarken, 1);
        SetBlendState(BS_Max, float4(0.f, 0.f, 0.f, 0.f), 0xffffffff);
    ...
    pass DefaultPass_Mirror_DepthIgnoreStencilMask //20
    {
        SetRasterizerState(RS_Cull_None);
        SetDepthStencilState(DSS_SpotlightDarken, 1);
        SetBlendState(BS_Default, float4(0.f, 0.f, 0.f, 0.f), 0xffffffff);
    ...
    pass AlphaBlend_Mirror_DepthIgnoreStencilMask //21
    {
        SetRasterizerState(RS_Cull_None);
        SetDepthStencilState(DSS_SpotlightDarken, 1);
        SetBlendState(BS_AlphaBlend, float4(0.f, 0.f, 0.f, 0.f), 0xffffffff);
    ...
    pass Additive_Mirror_DepthIgnoreStencilMask //22
    {
        SetRasterizerState(RS_Cull_None);
        SetDepthStencilState(DSS_SpotlightDarken, 1);
        SetBlendState(BS_Additive, float4(0.f, 0.f, 0.f, 0.f), 0xffffffff);
    ...
    pass Max_Mirror_DepthIgnoreStencilMask //23
    {
        SetRasterizerState(RS_Cull_None);
        SetDepthStencilState(DSS_SpotlightDarken, 1);
        SetBlendState(BS_Max, float4(0.f, 0.f, 0.f, 0.f), 0xffffffff);
